            ...
            <Container maxWidth="lg">
                <Grid container spacing={8}>
                    ...
                    <Grid size={{ xs: 12, md: 4 }}>
                        <Typography variant="h4" sx={{ color: 'secondary.main', mb: 2, fontFamily: 'serif' }}>
                            LA Clinic Studio
                        </Typography>
                        ...
                        <Box sx={{ display: 'flex', gap: 2 }}>
                            <IconButton component="a" href="https://instagram.com" target="_blank" sx={{ color: 'white', '&:hover': { color: 'secondary.main' } }}>
                                <Instagram />
                            </IconButton>
                            {/* Add other socials */}
                        </Box>
                    ...
                    <Grid size={{ xs: 12, md: 4 }}>
                        <Box sx={{ width: '100%', height: '200px', bgcolor: 'grey.800', borderRadius: '4px', overflow: 'hidden' }}>
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.096530669288!2d-34.8777!3d-7.1153!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zN8KwMDYnNTUuMSJTIDM0wrA1Mic0MC4wIlc!5e0!3m2!1sen!2sbr!4v1620000000000!5m2!1sen!2sbr"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
